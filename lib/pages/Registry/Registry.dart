                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                ...
                                // 正则校验：允许 0-9 a-z, A-Z, _, 中文
                                final RegExp nameExp = RegExp(r'^[0-9a-zA-Z_\u4e00-\u9fa5]+$');
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: isPressRestry ? Theme.of(context).colorScheme.surface : Theme.of(context).colorScheme.primary,
                                border: Border.all(color: Theme.of(context).colorScheme.primary, width: 4),
                              ),
                              child: Text(
                                "注    册",
                                style: TextStyle(color: isPressRestry ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onError, fontSize: 25),
                              ),
                            ),
                          ),
                          SizedBox(height: 20),
                          Row(
                            children: [
                              Text("已有账号？", style: TextStyle(color: Theme.of(context).colorScheme.onBackground)),
                              TextButton(
